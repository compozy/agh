...
func TestBrokerRegisterPromptDeliveryClawpatch(t *testing.T) {
	t.Parallel()
...
func TestBrokerProjectEventClawpatch(t *testing.T) {
	t.Parallel()
...
func TestBrokerRouteLifecycleClawpatch(t *testing.T) {
	t.Parallel()
