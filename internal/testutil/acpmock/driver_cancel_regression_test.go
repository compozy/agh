...
func TestDriverSandboxCancellationCleanup(t *testing.T) {
	...
	t.Run("Should release terminal after canceled sandbox exec", func(t *testing.T) {
		...
		fixturePath := writeDriverRegressionFixture(t, "sandbox-cancel-fixture.json", `{
			"version": 2,
			"agents": [
				{
					"name": "sandboxer",
...
func TestDriverLateCancelDoesNotPoisonNextPrompt(t *testing.T) {
	...
	t.Run("Should ignore cancel after prompt completion", func(t *testing.T) {
		...
		fixturePath := writeDriverRegressionFixture(t, "late-cancel-fixture.json", `{
			"version": 2,
			"agents": [
				{
					"name": "late-cancel",
...
func writeDriverRegressionFixture(t testing.TB, name string, fixture string) string {
	t.Helper()
