...
func taskRunFromGenerated(row *sqlcgen.GetTaskRunRow) (taskpkg.Run, error) {
	...
	fields := taskRunScanFields{
		...
		coordChannelID:       row.CoordinationChannelID,
...
func insertTaskParams(record taskpkg.Task) sqlcgen.InsertTaskParams {
	return sqlcgen.InsertTaskParams{
		...
		NetworkChannel:     nullableTaskString(record.NetworkChannel),
		Title:              record.Title,
...
func taskRunParams(run taskpkg.Run) sqlcgen.InsertTaskRunParams {
	...
	return sqlcgen.InsertTaskRunParams{
		...
		NetworkChannel:        nullableTaskString(run.NetworkChannel),
		...
		CoordinationChannelID: nullableTaskString(run.CoordinationChannelID),
...
func updateTaskRunParams(run taskpkg.Run) sqlcgen.UpdateTaskRunParams {
	insert := taskRunParams(run)
	return sqlcgen.UpdateTaskRunParams{
		...
		CoordinationChannelID: insert.CoordinationChannelID,
