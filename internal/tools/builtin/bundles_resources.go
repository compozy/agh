...
const bundleActivateInputSchema = `{"type":"object","required":["extension_name","bundle_name"],"properties":{"extension_name":{"type":"string"},"bundle_name":{"type":"string"},"profile_name":{"type":"string"},"scope":{"type":"string"},"workspace":{"type":"string"}},"additionalProperties":false}`
