...
var windowManagerToolSpecs = []windowManagerDescriptorSpec{
	...
	},
	{
		...
		risk: toolspkg.RiskMutating, capability: windowManagerWriteCapability,
		tags: []string{windowManagerTag, windowManagerDesktopsTag, "switch", "client"},
	},
	{
	...
	},
	{
		...
		risk: toolspkg.RiskMutating, capability: windowManagerWriteCapability,
		tags: []string{windowManagerTag, windowManagerWindowsTag, "focus", "client"},
	},
	{
		id: toolspkg.ToolIDWindowMove, nativeName: "window_move", title: "Window Move",
		description: "Move a window across desktops or structurally place it beside another window.",
	...
	},
	{
		...
		inputSchema: windowManagerReadInputSchema, outputSchema: windowManagerReadOutputSchema,
		risk: toolspkg.RiskRead, readOnly: true, capability: windowManagerReadCapability,
		tags: []string{windowManagerTag, windowManagerLayoutTag, "snapshot"},
	},
	{
		...
		inputSchema: windowManagerLayoutPreviewInputSchema, outputSchema: windowManagerCommandOutputSchema,
		risk: toolspkg.RiskRead, readOnly: true, capability: windowManagerReadCapability,
	...
	},
	{
		...
		risk: toolspkg.RiskRead, readOnly: true, capability: windowManagerReadCapability,
		tags: []string{windowManagerTag, windowManagerLayoutTag, "validate", "diagnostics"},
	},
	{
