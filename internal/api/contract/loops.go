...
const (
	...
	LoopRunStatusNoOp          LoopRunStatus = "no_op"
...
// LoopCatalogEntryPayload is the catalog projection used by list views.
type LoopCatalogEntryPayload struct {
	...
	LastRun       *LoopRunPayload             `json:"last_run,omitempty"`
