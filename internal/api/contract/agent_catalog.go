...
// AgentSessionCountsPayload contains exact visible-session totals for one
// workspace-scoped agent.
type AgentSessionCountsPayload struct {
...
type AgentCatalogItemPayload struct {
	...
	Sessions *AgentSessionCountsPayload `json:"sessions,omitempty"`
}
