...
var operationRegistry = []OperationSpec{
	...
	},
	{
		...
		Transports:  []Transport{TransportHTTP, TransportUDS},
		Parameters: []ParameterSpec{
			queryParam(specWorkspaceKey, "Workspace id, name, or path used to resolve workspace-local agents", false),
		},
		Responses: []ResponseSpec{
	...
	},
	{
		...
		Parameters: []ParameterSpec{
			...
			queryParam(specWorkspaceKey, "Workspace id, name, or path used to resolve a workspace-local agent", false),
		},
		Responses: []ResponseSpec{
