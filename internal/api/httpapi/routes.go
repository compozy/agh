...
func registerNetworkRoutes(api gin.IRouter, handlers *Handlers) {
	...
	networkGroup.GET("/channels/:channel/threads", handlers.NetworkThreads)
	networkGroup.GET("/channels/:channel/threads/:thread_id", handlers.NetworkThread)
	networkGroup.GET("/channels/:channel/threads/:thread_id/messages", handlers.NetworkThreadMessages)
	networkGroup.GET("/channels/:channel/directs", handlers.NetworkDirectRooms)
	networkGroup.POST("/channels/:channel/directs/resolve", handlers.ResolveNetworkDirectRoom)
	networkGroup.GET("/channels/:channel/directs/:direct_id", handlers.NetworkDirectRoom)
	networkGroup.GET("/channels/:channel/directs/:direct_id/messages", handlers.NetworkDirectRoomMessages)
	networkGroup.GET("/work/:work_id", handlers.NetworkWork)
