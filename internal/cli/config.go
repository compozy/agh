...
var (
	...
	configScalarMutationKinds = mergeConfigSetValueKinds(map[string]configSetValueKind{
		...
		"roles.coordinator.enabled":                           configSetBool,
		"roles.coordinator.agent":                             configSetString,
		"roles.coordinator.provider":                          configSetString,
		"roles.coordinator.model":                             configSetString,
		"roles.coordinator.reasoning_effort":                  configSetString,
		"roles.coordinator.ttl":                               configSetDuration,
		"roles.coordinator.max_children":                      configSetInt,
		"roles.coordinator.max_active_sessions_per_workspace": configSetInt,
		"roles.dream.enabled":                                 configSetBool,
		"roles.dream.agent":                                   configSetString,
		"roles.dream.provider":                                configSetString,
		"roles.dream.model":                                   configSetString,
		"roles.dream.reasoning_effort":                        configSetString,
		"roles.checkpoint_summary.enabled":                    configSetBool,
		"roles.checkpoint_summary.agent":                      configSetString,
		"roles.checkpoint_summary.provider":                   configSetString,
		"roles.checkpoint_summary.model":                      configSetString,
		"roles.checkpoint_summary.reasoning_effort":           configSetString,
		"roles.memory_extractor.enabled":                      configSetBool,
		"roles.memory_extractor.agent":                        configSetString,
		"roles.memory_extractor.provider":                     configSetString,
		"roles.memory_extractor.model":                        configSetString,
		"roles.memory_extractor.reasoning_effort":             configSetString,
		"roles.auto_title.enabled":                            configSetBool,
		"roles.auto_title.agent":                              configSetString,
		"roles.auto_title.provider":                           configSetString,
		"roles.auto_title.model":                              configSetString,
		"roles.auto_title.reasoning_effort":                   configSetString,
		"roles.memory_controller.enabled":                     configSetBool,
		"roles.memory_controller.provider":                    configSetString,
		"roles.memory_controller.model":                       configSetString,
		"roles.memory_controller.reasoning_effort":            configSetString,
		"roles.memory_controller.timeout":                     configSetDuration,
		"roles.memory_controller.top_k":                       configSetInt,
		"roles.memory_controller.prompt_version":              configSetString,
		"roles.memory_controller.max_tokens_out":              configSetInt,
