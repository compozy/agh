...
Added by the Hermes bridge Task 02 impact flag. Provider-specific persona, journey, and charter expansion belongs to Task 09; Task 10 owns execution. Planning flag only; no QA session ran.
