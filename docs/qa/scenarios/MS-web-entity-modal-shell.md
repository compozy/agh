...
entry_points: web task editor modal; web automation job/trigger editor; web vault create and sandbox profile create/edit via SettingsEditorDialog; web marketplace MCP install secret fields
qa_status: untested
bug_ids:
fix_status:
retest_status:
