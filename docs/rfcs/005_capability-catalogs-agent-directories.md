...
This guide covers the runtime authoring and projection surface. For the self-contained agent-directory story, see [RFC 001](001_agent-md-with-skills-memory.md). For the wire contract, see [RFC 003](003_agh-network-v0.md).
