...
const icon = (paths, { size = 16, stroke = 2 } = {}) => ({ size: s = size, ...rest } = {}) => (
...
const Icon = {
  ...
  Network: icon(<><rect x="16" y="16" width="6" height="6" rx="1" /><rect x="2" y="16" width="6" height="6" rx="1" /><rect x="9" y="2" width="6" height="6" rx="1" /><path d="M5 16v-3a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v3" /><path d="M12 12V8" /></>),
  ListChecks: icon(<><polyline points="3 7 5 9 9 5" /><polyline points="3 17 5 19 9 15" /><line x1="13" y1="7" x2="21" y2="7" /><line x1="13" y1="17" x2="21" y2="17" /></>),
  Bot: icon(<><rect x="3" y="8" width="18" height="12" rx="2" /><path d="M10 8V4a2 2 0 0 1 4 0v4" /><circle cx="8.5" cy="14" r=".5" fill="currentColor" /><circle cx="15.5" cy="14" r=".5" fill="currentColor" /></>),
  Waypoints: icon(<><circle cx="12" cy="4.5" r="2.5" /><circle cx="4.5" cy="19.5" r="2.5" /><circle cx="19.5" cy="19.5" r="2.5" /><path d="M6 18 11 8" /><path d="M13 8l5 10" /></>),
  Book: icon(<><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20" /></>),
  Wrench: icon(<path d="M14.7 6.3a4 4 0 0 0-5.4 5.4L3 18l3 3 6.3-6.3a4 4 0 0 0 5.4-5.4L15 12l-3-3 2.7-2.7z" />),
  ...
  FileCode: icon(<><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /><polyline points="10 13 8 15 10 17" /><polyline points="14 13 16 15 14 17" /></>),
  MoreHorizontal: icon(<><circle cx="12" cy="12" r="1" fill="currentColor" /><circle cx="19" cy="12" r="1" fill="currentColor" /><circle cx="5" cy="12" r="1" fill="currentColor" /></>),
  ArrowRight: icon(<><line x1="5" y1="12" x2="19" y2="12" /><polyline points="12 5 19 12 12 19" /></>),
  Circle: icon(<circle cx="12" cy="12" r="10" />),
  CircleDot: icon(<><circle cx="12" cy="12" r="10" /><circle cx="12" cy="12" r="3" fill="currentColor" /></>),
  ...
  Globe: icon(<><circle cx="12" cy="12" r="10" /><line x1="2" y1="12" x2="22" y2="12" /><path d="M12 2a15 15 0 0 1 0 20 15 15 0 0 1 0-20z" /></>),
  ...
  LayoutDashboard: icon(<><rect x="3" y="3" width="7" height="9" /><rect x="14" y="3" width="7" height="5" /><rect x="14" y="12" width="7" height="9" /><rect x="3" y="16" width="7" height="5" /></>),
  Columns: icon(<><rect x="3" y="3" width="18" height="18" rx="2" /><line x1="12" y1="3" x2="12" y2="21" /></>),
  List: icon(<><line x1="8" y1="6" x2="21" y2="6" /><line x1="8" y1="12" x2="21" y2="12" /><line x1="8" y1="18" x2="21" y2="18" /><circle cx="4" cy="6" r="1" fill="currentColor" /><circle cx="4" cy="12" r="1" fill="currentColor" /><circle cx="4" cy="18" r="1" fill="currentColor" /></>),
  Sparkles: icon(<><path d="M12 3l1.5 4.5L18 9l-4.5 1.5L12 15l-1.5-4.5L6 9l4.5-1.5z" /><path d="M19 14l.7 2.1L22 17l-2.3.9L19 20l-.7-2.1L16 17l2.3-.9z" /></>),
  Slack: icon(<><rect x="13" y="2" width="3" height="8" rx="1.5" /><rect x="14" y="11" width="8" height="3" rx="1.5" /><rect x="8" y="14" width="3" height="8" rx="1.5" /><rect x="2" y="10" width="8" height="3" rx="1.5" /></>),
  ...
  Key: icon(<><circle cx="8" cy="15" r="4" /><line x1="10.85" y1="12.15" x2="21" y2="2" /><line x1="18" y1="5" x2="21" y2="8" /><line x1="15" y1="8" x2="18" y2="11" /></>),
  Server: icon(<><rect x="2" y="3" width="20" height="8" rx="2" /><rect x="2" y="13" width="20" height="8" rx="2" /><line x1="6" y1="7" x2="6.01" y2="7" /><line x1="6" y1="17" x2="6.01" y2="17" /></>),
  Shield: icon(<path d="M12 2l9 4v6c0 5-3.5 9-9 10-5.5-1-9-5-9-10V6l9-4z" />),
  ...
  Puzzle: icon(<path d="M20.5 11H19V7a2 2 0 0 0-2-2h-4V3.5a2.5 2.5 0 0 0-5 0V5H4a2 2 0 0 0-2 2v4.5H3.5a2.5 2.5 0 0 1 0 5H2V21a2 2 0 0 0 2 2h4.5v-1.5a2.5 2.5 0 0 1 5 0V23H17a2 2 0 0 0 2-2v-4h1.5a2.5 2.5 0 0 0 0-5z" />),
  Trash: icon(<><polyline points="3 6 5 6 21 6" /><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6" /><path d="M10 11v6" /><path d="M14 11v6" /></>),
  ...
  Edit: icon(<><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" /><polygon points="18.5 2.5 21.5 5.5 12 15 9 15 9 12 18.5 2.5" /></>),
  ...
  Link2: icon(<><path d="M15 7h3a5 5 0 0 1 5 5 5 5 0 0 1-5 5h-3m-6 0H6a5 5 0 0 1-5-5 5 5 0 0 1 5-5h3" /><line x1="8" y1="12" x2="16" y2="12" /></>),
  ...
  Webhook: icon(<><path d="M18 16.98h-5.99c-1.1 0-1.95.94-2.48 1.9A4 4 0 0 1 2 17c.01-.7.2-1.4.57-2" /><path d="m6 17 3.13-5.78c.53-.97.1-2.18-.5-3.1a4 4 0 1 1 6.89-4.06" /><path d="m12 6 3.13 5.73C15.66 12.7 16.9 13 18 13a4 4 0 0 1 0 8" /></>),
  ...
  HardDrive: icon(<><line x1="22" y1="12" x2="2" y2="12" /><path d="M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z" /><line x1="6" y1="16" x2="6.01" y2="16" /><line x1="10" y1="16" x2="10.01" y2="16" /></>),
  BarChart: icon(<><line x1="12" y1="20" x2="12" y2="10" /><line x1="18" y1="20" x2="18" y2="4" /><line x1="6" y1="20" x2="6" y2="16" /></>),
  LineChart: icon(<><path d="M3 3v18h18" /><path d="M7 14l4-4 4 4 5-5" /></>),
  ...
  Users2: icon(<><path d="M17 21v-2a4 4 0 0 0-3-3.87" /><path d="M14 3.13a4 4 0 0 1 0 7.75" /><circle cx="9" cy="7" r="4" /><path d="M1 21v-2a4 4 0 0 1 4-4h8a4 4 0 0 1 4 4v2" /></>),
  GitCommit: icon(<><circle cx="12" cy="12" r="3" /><line x1="3" y1="12" x2="9" y2="12" /><line x1="15" y1="12" x2="21" y2="12" /></>),
  GitMerge: icon(<><circle cx="18" cy="18" r="3" /><circle cx="6" cy="6" r="3" /><path d="M6 21V9a9 9 0 0 0 9 9" /></>),
  ...
  FlaskConical: icon(<path d="M10 2v7.31l-6.72 9.95A2 2 0 0 0 5 22h14a2 2 0 0 0 1.72-2.74L14 9.31V2M7 17h10" />),
  ...
  Volume: icon(<><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5" /></>),
  ...
  ArrowUpDown: icon(<><polyline points="7 15 12 20 17 15" /><polyline points="7 9 12 4 17 9" /></>),
  CheckCircle: icon(<><circle cx="12" cy="12" r="10" /><polyline points="9 12 12 15 17 10" /></>),
  ...
  MoreVertical: icon(<><circle cx="12" cy="5" r="1" fill="currentColor" /><circle cx="12" cy="12" r="1" fill="currentColor" /><circle cx="12" cy="19" r="1" fill="currentColor" /></>),
  FolderTree: icon(<><path d="M13 10h7a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1h-2.88a1 1 0 0 1-.7-.3l-.82-.82a1 1 0 0 0-.7-.29H13a1 1 0 0 0-1 1v5a1 1 0 0 0 1 1z" /><path d="M13 21h7a1 1 0 0 0 1-1v-4a1 1 0 0 0-1-1h-2.88a1 1 0 0 1-.7-.3l-.82-.82a1 1 0 0 0-.7-.29H13a1 1 0 0 0-1 1v5a1 1 0 0 0 1 1z" /><path d="M3 3v16a2 2 0 0 0 2 2h7" /></>),
  ...
  Terminal2: icon(<><rect x="2" y="4" width="20" height="16" rx="2" /><polyline points="6 9 9 12 6 15" /><line x1="12" y1="15" x2="16" y2="15" /></>),
  BrainCog: icon(<><path d="M12 4.5a2.5 2.5 0 0 0-4.96-.46A2.5 2.5 0 0 0 3 9.5a2.5 2.5 0 0 0 .1 4.9 2.5 2.5 0 0 0 4.9 3.1 2.5 2.5 0 0 0 4 0 2.5 2.5 0 0 0 4.9-3.1 2.5 2.5 0 0 0 .1-4.9 2.5 2.5 0 0 0-4.04-4.96A2.5 2.5 0 0 0 12 4.5z" /></>),
};
