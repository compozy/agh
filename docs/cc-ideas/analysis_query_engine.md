...
Plus reactive recovery AFTER a failed API call: 6. Context collapse drain (`contextCollapse.recoverFromOverflow`) 7. Reactive compact (`reactiveCompact.tryReactiveCompact`)
