...
function TypingDots({ className, ...props }: TypingDotsProps) {
  return (
    ...
    >
      <span className="size-1 rounded-full bg-[color:var(--subtle)] [animation:typing-bounce_1.2s_infinite_ease-in-out]" />
      <span className="size-1 rounded-full bg-[color:var(--subtle)] [animation:typing-bounce_1.2s_infinite_ease-in-out_0.15s]" />
      <span className="size-1 rounded-full bg-[color:var(--subtle)] [animation:typing-bounce_1.2s_infinite_ease-in-out_0.3s]" />
    </span>
  );
}
