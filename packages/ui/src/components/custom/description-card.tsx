...
function SafeImage({
  ...
  return (
    <img
      ...
      height={height}
      title={title}
      className={cn("max-w-full rounded-(--radius)", className)}
    />
  );
}
  ...
  return (
    <section
      ...
      className={cn(
        bare
          ? "flex flex-col"
          : "flex flex-col rounded-(--radius-lg) bg-(--canvas-soft) px-[18px] py-4",
        className
      )}
      {...props}
    >
      <div
        ...
        className="max-w-[72ch] text-[length:var(--text-body)] leading-[1.7] text-(--fg) [&_a]:text-(--accent) [&_a]:underline [&_a]:underline-offset-2 [&_blockquote]:my-3 [&_blockquote]:border-l-2 [&_blockquote]:border-(--line-strong) [&_blockquote]:pl-3 [&_blockquote]:text-(--muted) [&_code]:rounded-(--radius-xs) [&_code]:bg-(--surface-glaze) [&_code]:px-1 [&_code]:py-px [&_code]:text-(--fg-strong) [&_code]:font-mono [&_code]:text-[12.5px] [&_h1]:mt-5 [&_h1]:mb-2 [&_h1]:text-[length:var(--text-section-head)] [&_h1]:font-medium [&_h1]:tracking-(--tracking-section-head) [&_h1]:text-(--fg-strong) [&_h2]:mt-5 [&_h2]:mb-2 [&_h2]:text-[length:var(--text-section-head)] [&_h2]:font-medium [&_h2]:tracking-(--tracking-section-head) [&_h2]:text-(--fg-strong) [&_h3]:mt-4 [&_h3]:mb-1.5 [&_h3]:text-[13px] [&_h3]:font-medium [&_h3]:text-(--fg-strong) [&_h4]:mt-3 [&_h4]:mb-1 [&_h4]:text-[12.5px] [&_h4]:font-medium [&_h4]:text-(--fg) [&_h5]:mt-3 [&_h5]:mb-1 [&_h5]:text-[12px] [&_h5]:font-medium [&_h5]:text-(--fg) [&_h6]:mt-3 [&_h6]:mb-1 [&_h6]:text-[12px] [&_h6]:font-medium [&_h6]:text-(--muted) [&_hr]:my-4 [&_hr]:border-(--line) [&_li]:my-0.5 [&_ol]:my-2 [&_ol]:list-decimal [&_ol]:pl-5 [&_p]:my-2 [&_pre]:my-3 [&_pre]:overflow-x-auto [&_pre]:rounded-(--radius) [&_pre]:bg-(--canvas) [&_pre]:p-3 [&_pre]:text-[12.5px] [&_pre]:font-mono [&_pre_code]:bg-transparent [&_pre_code]:px-0 [&_strong]:text-(--fg-strong) [&_table]:my-3 [&_table]:w-full [&_table]:border-collapse [&_th]:border-b [&_th]:border-(--line-strong) [&_th]:px-2 [&_th]:py-1.5 [&_th]:text-left [&_th]:text-[12px] [&_th]:font-medium [&_th]:text-(--fg-strong) [&_td]:border-b [&_td]:border-(--line) [&_td]:px-2 [&_td]:py-1.5 [&_td]:text-[12.5px] [&_ul]:my-2 [&_ul]:list-disc [&_ul]:pl-5"
      >
