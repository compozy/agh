...
function DescriptionCard({ children, bare = false, className, ...props }: DescriptionCardProps) {
  return (
    <section
      ...
      className={cn(
        bare ? "flex flex-col" : "flex flex-col rounded-lg bg-(--canvas-soft) px-[18px] py-4",
        className
      )}
      {...props}
    >
