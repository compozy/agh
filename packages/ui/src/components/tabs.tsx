  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "group-data-[variant=lane]/tabs-list:[&:not(:first-child)]:before:content-['·'] group-data-[variant=lane]/tabs-list:[&:not(:first-child)]:before:text-(--faint) group-data-[variant=lane]/tabs-list:[&:not(:first-child)]:before:opacity-50 group-data-[variant=lane]/tabs-list:[&:not(:first-child)]:before:px-1.5 group-data-[variant=lane]/tabs-list:[&:not(:first-child)]:before:select-none",
