    ...
    <main id="main-content" className="flex min-h-[calc(100dvh-3.5rem)] items-center px-4 py-20">
      <section className="mx-auto w-full max-w-[760px] rounded-(--radius-diagram) border border-(--line) bg-(--canvas-soft) p-8 md:p-10">
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
          <Link
            href="/runtime/"
            className="inline-flex h-10 items-center justify-center rounded-lg bg-accent px-5 text-sm font-medium text-white transition-colors hover:bg-(--accent-hover) active:translate-y-px"
          >
            Runtime docs
          </Link>
          <Link
