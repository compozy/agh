      ...
      <div className="mx-auto max-w-[var(--site-layout-width)]">
        <div className="flex flex-col gap-12 lg:flex-row lg:items-start lg:justify-between lg:gap-16">
          ...
          <div className="w-full lg:max-w-[420px]">
            <div className="rounded-[24px] bg-[var(--color-canvas)] p-6 md:p-8">
              ...
              <div className="mt-6 flex flex-col gap-6">
                {controlNotes.map(note => (
                  <div
                    key={note.label}
                    className="border-b border-[var(--color-divider)] pb-6 last:border-b-0 last:pb-0"
                  >
                    <p className="text-[1.05rem] font-medium text-[var(--color-text-primary)]">
                      {note.label}
                    </p>
        ...
        <div className="mt-16 rounded-[24px] bg-[var(--color-canvas)] p-6 md:p-10">
          <div className="flex flex-col gap-4 border-b border-[var(--color-divider)] pb-6 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <p className="font-mono text-[11px] font-medium uppercase tracking-[0.06em] text-[var(--color-accent)]">
                Runtime map
              </p>
              <p className="mt-2 text-[1.1rem] font-medium leading-tight text-[var(--color-text-primary)]">
