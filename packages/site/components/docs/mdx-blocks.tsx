...
export function GuideCard({ href, label, title, description, meta }: GuideCardProps) {
  return (
    <Link
      href={href}
      className="group flex min-h-[220px] flex-col justify-between rounded-xl border border-(--line) bg-(--canvas-soft) p-5 transition-colors hover:border-accent/40 md:p-6"
    >
      <div>
