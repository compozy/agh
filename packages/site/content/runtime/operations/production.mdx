...
For concrete service files, see [Daemon Operations](/runtime/operations/daemon).
...
Use one of the backup procedures in [Database Operations](/runtime/operations/database). For
...
- [Daemon Operations](/runtime/operations/daemon) shows service manager setup.
- [Database Operations](/runtime/operations/database) gives backup and inspection commands.
- [Troubleshooting](/runtime/operations/troubleshooting) maps common failures to fixes.
