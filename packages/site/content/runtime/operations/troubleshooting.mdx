...
directory ownership in [config.toml](/runtime/reference/config-toml).
...
See [Spawning](/runtime/agents/spawning) for the exact launch and ACP negotiation flow.
...
For backup and restore details, see [Database Operations](/runtime/operations/database).
...
- [Daemon Operations](/runtime/operations/daemon) covers lock, socket, logs, and service manager behavior.
- [Database Operations](/runtime/operations/database) covers backup and inspection procedures.
- [Production Checklist](/runtime/operations/production) turns these checks into a readiness gate.
