...
Skill source precedence is bundled, marketplace, user, additional root, then workspace.
...
- [config.toml Reference](/runtime/reference/config-toml) documents the schema for global and workspace config files.
- [mcp.json Reference](/runtime/reference/mcp-json) documents JSON sidecars.
- [Workspace Resolver](/runtime/workspaces/resolver) explains how AGH finds the primary workspace root.
