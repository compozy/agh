...
- [config.toml Reference](/runtime/reference/config-toml) documents provider and permission defaults.
- [mcp.json Reference](/runtime/reference/mcp-json) documents sidecar schema and replacement rules.
- [Agent Providers](/runtime/agents/providers) explains built-in provider behavior.
