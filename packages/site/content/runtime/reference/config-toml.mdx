...
- [mcp.json Reference](/runtime/reference/mcp-json) documents JSON sidecars and whole-object replacement.
- [AGENT.md Reference](/runtime/reference/agent-md) documents agent-local `mcp_servers` and hooks.
- [File Locations](/runtime/reference/file-locations) lists the exact global and workspace paths.
