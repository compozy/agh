...
frontmatter server object. See [mcp.json Reference](/runtime/reference/mcp-json) for the shared
JSON schema.
...
| Source precedence                | Bundled, marketplace, user, additional root, workspace                     |
...
- [config.toml Reference](/runtime/reference/config-toml) documents skill marketplace trust gates.
- [mcp.json Reference](/runtime/reference/mcp-json) documents sidecar validation and replacement.
- [Skills Overview](/runtime/skills/overview) explains catalog source precedence.
