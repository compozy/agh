...
- [Workspace Resolver](/runtime/workspaces/resolver) explains when config loading happens.
- [Multi-Root Workspaces](/runtime/workspaces/multi-root) explains why additional roots do not add config overlays.
- [Agent Definitions](/runtime/agents/definitions) documents agent-local MCP sidecars.
- [Skills Overview](/runtime/skills/overview) documents skill-local MCP sidecars and disabled skill behavior.
