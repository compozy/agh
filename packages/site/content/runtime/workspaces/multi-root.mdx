...
- [Workspace Resolver](/runtime/workspaces/resolver) explains the registration and lookup model.
- [Config Overlays](/runtime/workspaces/config-overlays) explains why config comes only from the primary root.
- [Skills Overview](/runtime/skills/overview) explains how workspace skill paths overlay the global registry.
- [Agent Definitions](/runtime/agents/definitions) documents agent discovery and parser behavior.
