...
- [Skills Overview](/runtime/skills/overview) explains where bundled skills sit in the hierarchy.
- [SKILL.md Format](/runtime/skills/skill-md) documents the file format used by bundled and local skills.
- [Session Lifecycle](/runtime/sessions/lifecycle) gives the runtime background for `agh-session-guide`.
- [Memory System](/runtime/memory/system) gives the runtime background for `agh-memory-guide`.
