...
- [SKILL.md Format](/runtime/skills/skill-md) documents the file format and schema.
- [Marketplace](/runtime/skills/marketplace) shows how to search, install, update, and remove skills.
- [Bundled Skills](/runtime/skills/bundled) lists the skills shipped in the AGH binary.
- [Agent Definitions](/runtime/agents/definitions) explains how agents and skill-aware MCP servers meet at session start.
- [Spawning](/runtime/agents/spawning) follows the ACP startup path that receives skill MCP servers.
