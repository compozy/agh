...
- [SKILL.md Format](/runtime/skills/skill-md) documents `.agh-meta.json`, MCP declarations, and hooks.
- [Bundled Skills](/runtime/skills/bundled) lists the trusted skills shipped with AGH.
