...
That durable store is what makes [resume](/runtime/sessions/resume), [event replay](/runtime/sessions/events), and [approval audit](/runtime/sessions/permissions) possible.
...
- Use [Resume and Replay](/runtime/sessions/resume) when you need to continue a stopped session.
- Use [Event Streaming](/runtime/sessions/events) when you need the exact stored and streamed session record.
- Use [Permissions](/runtime/sessions/permissions) when you need to control or approve agent actions.
