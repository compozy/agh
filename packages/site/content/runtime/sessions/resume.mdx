...
- Use [Event Streaming](/runtime/sessions/events) to inspect the stored event log and live SSE stream.
- Use [Permissions](/runtime/sessions/permissions) to understand what survives across resume and what still needs approval.
