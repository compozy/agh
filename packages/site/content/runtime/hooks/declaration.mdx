...
| `event`                                             | yes                       | One event from the [event catalog](/runtime/hooks/event-catalog).                                   |
...
Inspect the resolved catalog and execution history:
...
- [Hook Event Catalog](/runtime/hooks/event-catalog)
- [Hooks CLI Reference](/runtime/cli-reference/hooks)
- [SKILL.md Format](/runtime/skills/skill-md)
- [Extensions Development](/runtime/extensions/develop)
