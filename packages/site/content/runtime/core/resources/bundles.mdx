...
agh bundle update act_123 --confirm-network-requirement
...
| `409` on activation                        | Unconfirmed Live requirement or bundled-agent conflict. | Activation digest and visible agents.            |
