...
Use this page when you need to understand why a tool, MCP server, agent definition, skill,
automation job, trigger, bridge instance, or bundle activation can be managed through the same
control plane.
