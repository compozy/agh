...
agent sidecar, skill, automation job, trigger, bridge instance, or bundle activation can be managed
...
<Mermaid
  chart={`flowchart TD
    ...
    Projectors --> Runtime[Tools, agents, skills, automation, bridges, bundles]
...
| `bundle.activation`  | Active bundle profiles that project agents, sidecars, automation, bridges, and channels. |
