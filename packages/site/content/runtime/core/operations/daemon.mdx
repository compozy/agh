...
terminals, environment-backed terminals, hook subprocesses, managed extension processes, and shared
subprocess helpers.
...
- records without reusable local PID evidence, such as remote environment terminals, are retired as
...
them in [config.toml](/runtime/core/configuration/config-toml).
