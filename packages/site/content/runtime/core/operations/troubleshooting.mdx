...
Agent subprocesses inherit the daemon environment. If a provider needs `ANTHROPIC_API_KEY`,
`OPENAI_API_KEY`, `GEMINI_API_KEY`, or a custom variable, set it in the shell or service manager
