...
```bash
curl -X POST http://localhost:2123/api/workspaces/ws_alpha/sessions/sess-1234/resume
```
...
```bash
curl http://localhost:2123/api/workspaces/ws_alpha/sessions/sess-1234 | jq '.session.acp_caps'
```
...
```bash
curl http://localhost:2123/api/workspaces/ws_alpha/sessions/sess-1234/transcript
```
