...
- [Memory System](/runtime/core/memory/system) explains memory files and indexes.
- [Global vs Workspace Memory](/runtime/core/memory/scopes) explains storage and resolution rules.
- [Session Lifecycle](/runtime/core/sessions/lifecycle) documents the `dream` session type.
