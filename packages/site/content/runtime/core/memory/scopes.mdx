...
- [Memory System](/runtime/core/memory/system) explains the file format and prompt injection.
- [Dream Consolidation](/runtime/core/memory/dream) explains automatic and manual consolidation.
- [Agent Definitions](/runtime/core/agents/definitions) documents current `AGENT.md` parser limits.
