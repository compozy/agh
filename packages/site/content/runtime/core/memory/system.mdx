...
Dream consolidation is the normal way to tighten memory files over time. Manual writes and deletes
still keep the index synchronized so the next session can discover changed memories.
