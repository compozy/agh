...
The cursor advances only after confirmed delivery, deterministic skip, or bridge suppression. A
delivery error records cursor diagnostics and leaves the cursor unchanged so replay can retry the
same event.
