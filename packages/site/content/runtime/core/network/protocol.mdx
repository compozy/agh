...
lets two peers correlate direct work, receipts, and trace updates without creating a process graph.
...
<Mermaid
  ...
  caption="Interactions are correlation containers. They do not replace tasks, jobs, or runtime state."
/>
