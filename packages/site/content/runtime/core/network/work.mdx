...
- [Task Ingress](/runtime/core/network/task-ingress) explains how authenticated peers map to the
  durable task domain. `work_id` and `task_runs.id` are intentionally distinct.
