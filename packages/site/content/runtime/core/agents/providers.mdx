...
| Provider ID         | Harness  | Runtime provider    | Command                                                          | Default model               | Auth mode      | Credential target    |
| ------------------- | -------- | ------------------- | ---------------------------------------------------------------- | --------------------------- | -------------- | -------------------- |
...
| `default_model`       | string | no                       | Used when an `AGENT.md` omits `model`. Native `pi` receives it through ACP model selection.                   |
