...
- [config.toml Reference](/runtime/core/configuration/config-toml) documents top-level and provider MCP fields.
- [AGENT.md Reference](/runtime/core/configuration/agent-md) documents agent-local MCP declarations.
- [SKILL.md Reference](/runtime/core/configuration/skill-md) documents skill-local MCP declarations.
