...
[providers.claude]
# Overrides the built-in Claude provider command/model and records native auth diagnostics.
...
| `default_model`       | string                      | Built-in model or empty.                                                          | Any string.                                       | Model used when an agent omits `model`; native `pi` receives it through ACP model selection. |
...
| Built-in            | Harness  | Runtime provider    | Default model               | Auth mode      | Credential target    |
| ------------------- | -------- | ------------------- | --------------------------- | -------------- | -------------------- |
