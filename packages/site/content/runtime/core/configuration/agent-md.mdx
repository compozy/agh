...
| `tools`       | string array                | empty                                       | Exact canonical ToolIDs or namespace-prefix wildcards.              | Agent tool allowlist grammar.                                  |
| `toolsets`    | string array                | empty                                       | Canonical ToolsetIDs.                                               | Named tool bundles allowed for the agent.                      |
...
# Optional. Exact canonical ToolIDs or namespace-prefix wildcard patterns.
tools:
  - "agh__skill_view"
  - "mcp__github__*"

# Optional. Named ToolsetIDs.
toolsets:
  - "agh__catalog"
...
| Description  | Agent tool allowlist grammar consumed by the registry policy layer. It does not raise authority above `[permissions].mode`.                                                                                                    |
...
| Description  | Named tool bundles allowed for the agent. Toolsets are separate from `tools`; do not place toolset IDs in `tools`. |
