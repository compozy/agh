...
| `capabilities.toml` / `capabilities.json` or `capabilities/*.toml` / `capabilities/*.json` | Declare outcome-oriented capabilities advertised to network peers. | [Agent Capabilities](/runtime/core/agents/capabilities). |
