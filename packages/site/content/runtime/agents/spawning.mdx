...
- [Agent Definitions](/runtime/agents/definitions) shows how the launch inputs are declared.
- [Providers](/runtime/agents/providers) lists the built-in provider commands.
- [Session Lifecycle](/runtime/sessions/lifecycle) explains how the spawned process is wrapped by a durable AGH session.
