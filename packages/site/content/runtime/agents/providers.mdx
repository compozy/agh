...
- [Agent Definitions](/runtime/agents/definitions) explains the `AGENT.md` fields that reference providers.
- [Spawning](/runtime/agents/spawning) shows exactly how the resolved provider command becomes a running ACP process.
