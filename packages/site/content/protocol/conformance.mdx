...
| Require v1 namechannel-style `ext` keys                            | SHOULD | MUST   | MUST   |
...
| Extension fixtures    | Unknown extension keys, namechannel validation, extension processing after core validation.                                  |
