...
description: Reference for AGH Network v2 work_id semantics, opening directed work, progress streaming, lifecycle states, conversation-container binding, and timeout rules.
icon: Workflow
---
...
<Mermaid
  chart={`sequenceDiagram
    ...
    A->>B: say surface=thread thread_id=thread-launch work_id=work-123
