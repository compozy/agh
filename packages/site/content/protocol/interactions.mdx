...
- [Message Kinds](/protocol/message-kinds) defines the `direct`, `receipt`, and `trace` body shapes.
...
- [Task Ingress](/runtime/core/network/task-ingress) shows how AGH Runtime maps authenticated
  network work into task-domain writes.
