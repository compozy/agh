...
- creates a valid `agh-network/v2` envelope
...
| -------------- | ----------------------- | ------------------------------------------------------------- |
| `protocol`     | `agh-network/v2`        | Current AGH Runtime implements the v2 envelope.               |
| `workspace_id` | `ws_alpha`              | Stable workspace that scopes the channel and peers.           |
...
| --------------------- | --------------------------------------------------------- |
| `protocol`            | Exactly `agh-network/v2`.                                 |
...
| `proof`               | `null` for this v2 tutorial.                              |
