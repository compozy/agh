...
[signature verification](/protocol/verification/). The current AGH Runtime is still a v2
...
<OperatorNote label="Current AGH behavior">
  Current `internal/network` validates v2 envelopes and preserves `proof` as opaque JSON. It does
