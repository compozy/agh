...
func main() {
	...
	greet := envelope("msg_greet_01", "greet", channel, senderID, nil, map[string]any{
	...
	if err := publish(sender, broadcastSubject(channel), greet); err != nil {
		log.Fatalf("publish greet: %v", err)
	}

	threadSay := envelope("msg_say_01", "say", channel, senderID, nil, map[string]any{
	...
	if err := publish(sender, broadcastSubject(channel), threadSay); err != nil {
