---
title: Message Kinds
description: Reference for the six AGH Network v2 message kinds, their conversation surface and work rules, required body fields, and JSON examples.
icon: MessageSquare
---

AGH Network v2 defines six message kinds. The envelope selects the kind with the top-level `kind`
