...
export const Header: Story = {
  render: () => (
    <PanelSurface className="min-h-[160px] p-0">
      <div className="flex w-[420px] flex-col bg-[color:var(--color-canvas-deep)]">
        <ThreadOverlayHeader
          channel="ops"
...
export const RepliesPopulated: Story = {
  render: () => (
    <PanelSurface className="min-h-[480px] p-0">
      <div className="flex h-[480px] w-[420px] flex-col bg-[color:var(--color-canvas-deep)]">
...
export const RepliesLoading: Story = {
  render: () => (
    <PanelSurface className="min-h-[300px] p-0">
      <div className="flex h-[300px] w-[420px] flex-col bg-[color:var(--color-canvas-deep)]">
...
export const RepliesEmpty: Story = {
  render: () => (
    <PanelSurface className="min-h-[260px] p-0">
      <div className="flex h-[260px] w-[420px] flex-col bg-[color:var(--color-canvas-deep)]">
