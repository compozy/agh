...
/**
 * Window-scoped rewrite of the settings section nav: the active section comes
 * from the WINDOW's location, not the router match — an unfocused settings
 * window keeps its own highlight while the URL points at the focused window.
 */
export function SettingsWindowNav({ activeSlug }: { activeSlug: string }) {
  return (
    <nav
