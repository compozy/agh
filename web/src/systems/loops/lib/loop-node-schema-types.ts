 ...
 * one responsibility per file. This is the "schema generates the inspector" model (sim
 * precedent), derived from the canonical `agh.loop/v1` DSL types + the ADR-021 reserved
 * kinds; the inspector renders FROM these descriptors, it is not a second schema authority.
 */
