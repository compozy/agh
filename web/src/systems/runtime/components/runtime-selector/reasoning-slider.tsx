  ...
  return (
    ...
    >
        ...
        {slider.stops.map((effort, index) => {
          ...
          return (
            <button
              ...
              data-edge={edge}
              className={cn(
                "absolute top-0 rounded-xs px-0.5 text-badge leading-[18px] font-medium whitespace-nowrap text-muted transition-colors hover:text-fg",
                edge === "start" && "left-0",
                edge === "end" && "right-0",
      ...
      <div
        ...
        className="relative h-4 cursor-pointer rounded-full bg-canvas ring-1 ring-line-soft ring-inset outline-none focus-visible:ring-2 focus-visible:ring-accent"
