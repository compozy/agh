...
This is peer-review round 2. Round 1 returned blockers and nits; the author incorporated
all selected round 1 findings before this review. Treat the current TechSpec and ADRs as
the source of truth, and use the round 1 review/incorporation artifacts only to verify that
the remediation actually closed the previous gaps without introducing new ones.
