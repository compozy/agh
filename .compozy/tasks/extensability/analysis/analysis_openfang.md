...
| **Tool namespacing (mcp_ prefix)** | Prevent collisions between builtins, skills, and MCP tools | **CORE** | Any system that merges tools from multiple sources needs namespacing. This is a core protocol concern. |
...
OpenFang has no runtime extension loading -- everything is compiled in. This is the opposite of what AGH wants. However, the *boundaries* between OpenFang's subsystems reveal the natural extension points:
