...
- Tool process recovery must validate PID start-time evidence before signaling recovered processes; records without local PID evidence, including remote environment terminals, should be marked stale after restart rather than killed by PID.
