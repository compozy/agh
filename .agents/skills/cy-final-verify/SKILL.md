...
3. If the project keeps a living QA tracker (e.g. `docs/qa/state.csv`), apply the QA impact flag (see "QA Tracker Impact" below).
4. Produce a Verification Report (see template below) with verdict PASS.
